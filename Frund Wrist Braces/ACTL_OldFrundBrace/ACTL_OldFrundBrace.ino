...
#define OLD_FRUND_LED_COUNT 2

// How bright should the NeoPixels be? (0-255)
#define OLD_FRUND_LED_BRIGHTNESS 255 

// Declare our NeoPixel strip object:
Adafruit_NeoPixel strip(OLD_FRUND_LED_COUNT, LED_PIN, NEO_GRB + NEO_KHZ800);
...
uint32_t blue = strip.Color(0, 104, 240);
...
unsigned int oldFrundBlueState = 0;
unsigned int oldFrundGreenState = 0;
...
void setup() {
  ...
  strip.setBrightness(OLD_FRUND_LED_BRIGHTNESS); // Set BRIGHTNESS to about 1/5 (max = 255)
...
// This function will be called by handleOSCMessage()
void oldFrundBlueModule(OSCMessage &msg) {
  oldFrundBlueState = msg.getInt(0);

  Serial.print("/oldfrundblue: ");
  Serial.println(oldFrundBlueState);
}

// This function will be called by handleOSCMessage()
void oldFrundGreenModule(OSCMessage &msg) {
  oldFrundGreenState = msg.getInt(0);

  Serial.print("/oldfrundgreen: ");
  Serial.println(oldFrundGreenState);
}
